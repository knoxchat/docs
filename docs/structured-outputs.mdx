...
You can find the list of models supporting structured outputs on the [Models Page](https://knox.chat/modelslist).
...
1. Check the supported parameters for the model on the [Models Page](https://knox.chat/modelslist)  
