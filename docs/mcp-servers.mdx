...
By converting MCP (Anthropic) tool definitions into OpenAI-compatible tool definitions, you can use MCP servers with Knox.

In this example, we will use the [Anthropic MCP Client SDK](https://github.com/modelcontextprotocol/python-sdk?tab=readme-ov-file#writing-mcp-clients) to interact with a filesystem MCP, all in the background via Knox.
