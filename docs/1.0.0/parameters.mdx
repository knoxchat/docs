...
description: "Detailed documentation of parameters supported by the Knox API"
...
This page provides a complete list of all parameters supported by the Knox API.
...
## Knox Specific Parameters

The following parameters are specific to Knox:
...
| `transforms` | Array of Strings | None | List of prompt transformations (Knox only). |
