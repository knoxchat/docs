...
Knox exposes a dedicated **asynchronous** video generation API. Unlike chat completions, video jobs are submitted, polled until they finish, then downloaded as media files.
