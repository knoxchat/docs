...
| `GET/POST /v1/realtime` | Speech-to-speech Realtime WebSocket (`gpt-realtime-2.1`, `gpt-realtime-2.1-mini`) |
| `POST /v1/realtime/client_secrets` | Mint a Knox ephemeral Realtime key |
