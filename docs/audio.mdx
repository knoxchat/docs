...
For live speech-to-speech (microphone in, audio out) with `gpt-realtime-2.1` or `gpt-realtime-2.1-mini`, use the [Realtime](/realtime) API instead of `/v1/chat/completions`.
