...
:::info Note
  [All Knox Chat endpoints](https://knox.chat/models) with a context length no greater than 8k (8,192 tokens) will use `middle-out` by default. To disable this feature, set `transforms: []` in the request body.
:::
