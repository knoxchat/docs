...
- **Multimodal I/O**: text, images, PDFs, and audio inputs, plus image, video, and [music](/music) generation, [text to speech](/text-to-speech), [speech to text](/speech-to-text), and speech-to-speech [Realtime](/realtime).
