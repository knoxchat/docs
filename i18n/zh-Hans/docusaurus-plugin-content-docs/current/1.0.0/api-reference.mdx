...
id: api-reference
title: "API 参考"
description: "Knox Chat API 参考文档。"
...
您可以在 [**Knox Chat Token**](https://knox.chat/keys) 页面查找或创建 API key。
...
Knox Chat 支持多种参数来控制模型行为和输出。详情请参阅 [**API 参数**](/1.0.0/parameters) 章节。
...
Knox Chat 在不同模型和提供商之间标准化了 schema，以符合 [OpenAI Chat API](https://platform.openai.com/docs/api-reference/chat) 规范。
